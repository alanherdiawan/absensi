          ...
          <div class="col-12">
            <div class="card">
              ...
              <button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-default">
                  <a href="tambahdatadivisi.php">Tambah data</a>
                </button>
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <?php
                    $no=0;
                    $query=mysqli_query($koneksi, "SELECT * FROM mstdivisi");
                    while ($row=mysqli_fetch_assoc($query)){
                        $no++;
                        ?>
                    <tr>
                    <th><?php echo $no ?></th>
                    <th><?php echo $row['KodeDivisi']; ?></th>
                    <th><?php echo $row['NamaDivisi']; ?></th>
                    <td>
					<a href="deletedivisi.php?KodeDivisi=<?php echo $row['KodeDivisi']?>" class="btn btn-danger" role="button">Delete</a>
					</td>
